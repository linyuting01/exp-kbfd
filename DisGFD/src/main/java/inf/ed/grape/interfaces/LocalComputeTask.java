...
public abstract class LocalComputeTask {
	...
	public abstract void compute2(Partition partition);
	...
	public abstract void prepareResult(int flag);

	public abstract int incrementalCompute(Partition partition);
